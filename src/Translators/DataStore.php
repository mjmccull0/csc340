...
class DataStore {
   ...
   * @return StorageManager will return an array of matched records.
   */
   ...
   * @return StorageManager will return an array of records.
   */
   ...
   * @return StorageManager will return the record specified by that ID.
   */
   ...
   * @return StorageManager will return an array of sources found.
   */
   ...
   *
   * Calls the Text DB to give all sources of a given type it is currently using.
   *
   ...
   *
   * @return StorageManager will return an array of all records in db.
   */
   ...
   * @return StorageManager will return an array of the records found in the search.
   */
   ...
   *
   * This will call the database to return an array of the records in the database that
   * are of the specified type.
   *
   * @param $_type determines the type of recrods to be fetched
   * @return StorageManager will return an array of the records of the type.
   */
  ...
  /**
   * Feteches all sources our database draws from
   *
   * Calls the database and expects a return of an array of the types of sources we draw from and infromation
   * associated with them.
   *
   * @return StorageManager will return an array of the sources currently being used
   * in our database.
   */
   ...
   * @return StorageManager will return whatever the database will return,
  ...
  /**
   * Upadates the infomration associated with a given source we're drawing from
   *
   * Sends to the database changes to the specified source as given in the post form
   ...
   * we're holding.
   *
   * Will make the changes to the specified record as given in post form
